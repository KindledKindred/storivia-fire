  ...
  state: {
    ...
    worlds: [
      ...
      },
      {
        ...
        sound: 2,
        note:
          'ーこれはサンプルですー　村で１番小さい水車小屋．川の水量が少なくなってからはあまり動いていない．'
      },
      {
        id: 3,
        name: '父の書斎',
        ...
        sound: 1,
        note:
          'ーこれもサンプルですー　父の亡き後そのままにされている書斎だ．カーテンから漏れる陽光に舞い上がった埃が遊ぶように輝いている．'
      }
    ],
    // 物語の７つの機能，静的オブジェクト
    roles: [
    ...
    function31s: [
      ...
      },
      {
        ...
        name: '02. 禁止',
        description:
          '主人公が何かを禁じられる．あるいは社会に禁忌や危険な領域が存在する．'
      },
      {
        id: 3,
        name: '03. 違反',
      ...
      },
      {
        ...
        name: '04. 捜索',
        description:
          '敵対者が主人公の弱点，物語で重要な人やアイテムの在処，聖域などを探る．'
      },
      {
        id: 5,
        name: '05. 漏洩',
      ...
      },
      {
        ...
        name: '07. 幇助',
        description:
          '主人公が半強制的あるいは気付かずに敵対者を助ける．または主人公の仲間が買収される．先に報酬が提示される代わりに，将来的な不幸が約束されることもある．'
      },
      {
        id: 8,
        name: '08. 加害・欠如',
        description:
          '敵対者が主人公側の成員や社会に危害を及ぼす．昼の光を奪う，無理な結婚を強いる，殺害を命じる，誘き出す，略奪する，すり替える，追放するなど．または配偶者，金品，目標と現在のギャップ，その他様々なものの欠如を感じる．'
      },
      {
        id: 9,
        name: '09. 仲介・調停',
        description:
          '主人公が出発を命じられたり頼まれたり，惨状や悲嘆を耳にしたり目撃したりする．あるいは逃れられない状況に身を置く．'
      },
      {
        id: 10,
        name: '10. 決意・同意',
      ...
      },
      {
        ...
        name: '11. 出発',
        description:
          '[10. 決意・同意]のもと出発する．現状を再確認したり掘り下げることも．'
      },
      {
        id: 12,
        name: '12. 贈与者による試練',
      ...
      },
      {
        ...
        name: '13. 反応',
        description:
          '困難な試練を辛うじて達成する．あるいはギリギリで失敗する．贈与者自身が協力者となり，大きな困難を達成する．'
      },
      {
        id: 14,
        name: '14. 特別な手段の提供・獲得',
        description:
          '贈与者を協力者として得たり，秘儀，秘宝，パスワード，秘密の抜け道，強力な道具などを入手する．'
      },
      {
        id: 15,
        name: '15. 移動',
        description:
          '大掛かりな場面移動．新たな移動手段の獲得や強制的な移動など．飛行船，城外，タイムトラベル等．'
      },
      {
        id: 16,
        name: '16. 闘争・難題',
      ...
      },
      {
        ...
        name: '17. 徴付け・被照準',
        description:
          '主人公が特徴づけられ，敵対者に狙いを絞られる．庇護者の死，隠されていた主人公の露見，主人公の才能開花の確認等による照準移行'
      },
      {
        id: 18,
        name: '18. 勝利',
        description:
          '敵対者への完全なまたは一時的な勝利．戦闘，説得，逮捕，試合，脱出，耐久など．'
      },
      {
        id: 19,
        name: '19. 不幸・欠如の解消',
        description:
          '当初の目標の達成．呪いの解除，略奪品の回収，脅威の排除，和解，優勝，結婚など．'
      },
      {
        id: 20,
        name: '20. 帰還',
        description:
          '[15. 移動]していた主人公の帰還．エンディングへ．場合によっては帰路のみを指し物語を続行．'
      },
      {
        id: 21,
        name: '21. 被追跡',
        description:
          '[20. 帰還]中の主人公が密かに，あるいは荒々しく追跡される．物理的でなくとも，禍根が残っている様子も示す．'
      },
      {
        id: 22,
        name: '22. 救助',
        description:
          '[21. 被追跡]から救われる．追跡者の排除，誤解の解消，和解，匿われる，逃げ切りなど．'
      },
      {
        id: 23,
        name: '23. 隠蔽された到着',
        description:
          '気づかれずに主人公が帰還し終える．仲間と合流，どこかへ去る，主人公の死を想起させるなど．'
      },
      {
        id: 24,
        name: '24. 偽主人公の主張',
        description:
          '主人公やその成員を名乗る者が出現し，主人公の功績を我が物と言い張る．'
      },
      {
        id: 25,
        name: '25. 主人公への難題',
        description:
          '[24. 偽主人公の主張]に対し，自身が真の主人公であることを証明する試練．'
      },
      {
        id: 26,
        name: '26. 難題の完遂',
      ...
      },
      {
        ...
        name: '27. 主人公への再認識',
        description:
          '[17. 徴付け]時の徴により主人公であることを再認識．目，指輪，思い出，特殊な道具，傷跡など．'
      },
      {
        id: 28,
        name: '28. 偽主人公や敵対者の露見',
        description:
          '[27. 主人公への再認識]により偽主人公または敵対者の虚偽が露見する．主人公が本物である，主人公やその成員への悪い噂は嘘であるなど．'
      },
      {
        id: 29,
        name: '29. 変身',
        description:
          '主人公の容姿が一般に良い方向へ変化する．衣装，顔，種族など．あるいは成員や土地の変化．最上位のグループ，豪邸，使用していた武器の特別な修理など．'
      },
      {
        id: 30,
        name: '30. 敵対者の処遇決定',
      ...
      },
      {
        ...
        name: '31. エンディング',
        description:
          '物語としての終わり．主人公の結婚，優勝，昇格，死亡，失踪など．'
      }
    ],
    ...
    QandAs: [
      {
        ...
        question: 'アイデアが浮かばない',
        answer:
          '散歩に出かけましょう．トイレまででも構いません．でもスマホか手帳は持って！アイデアは机を離れた時に出がちです．思い浮かんだことを全部メモしてください．全部です！'
      },
      {
        id: 2,
        question: '何をすればいい？',
        answer:
          '全ては「パネル追加」から始まります．もし「シーン」や「行動者」の選択肢が無いと感じたなら，右上の「Character」や「World」からキャラクターやシーンの舞台を追加することができます．もしどんな風にパネルを加えていいか分からない場合は，多くを空欄にしてもいいので数を作っていきましょう．完璧なものを作るより，不満なものを後で編集・削除するほうが遥かに簡単です．'
      },
      // Action
      {
        id: 10,
        ...
        answer:
          '（誰が）何をするかを決めたものです．「何をするか」には適した31の順序があり，あなたはその中からいくつかを選んで使うことができます．'
      },

      {
        ...
        question: 'どの機能を描けばいい？',
        answer:
          '必ず描かなければいけない機能がない，ということが却って書くのを難しくしているのかもしれません．そんな時は「機能」を埋めずに一行メモだけを書いたパネルを量産するといいでしょう．「機能」は後から埋めることができますから．'
      },
      {
        id: 12,
        question: '描きたい場面はどの機能？',
        answer:
          'シーンをひとまず機能抜きで書いてみるといいでしょう．後から他のパネルと見比べて，整合性のある機能を当てはめるのも一つの方法です．'
      },
      {
        id: 13,
        question: 'どのキャラクターを出せばいい？',
        answer:
          'キャラクター欄を空欄にしてみましょう．それでもパネルを追加することができます．最後まで埋まらなければ，出番が少なかったり最後の登場から間隔の空いたキャラクターを選ぶといいでしょう．'
      },
      {
        id: 14,
        question: 'キャラクターの活躍方法は？',
        answer:
          '活躍を彩るには感情移入させる必要があります．感情移入させるには苦労や苦難が必要です．辛い部分を演出してから，それを乗り越えるような場面を作ることが活躍として受け取られやすいでしょう．'
      },
      {
        id: 15,
        question: '書きたいものが書けない',
        answer:
          '思い描くものと書き出すもののギャップはだれしもが感じることです．その差は経験を積み重ねることで埋まっていきます．まずはできる範囲で完成させてみましょう．'
      },
      // Character
      {
        id: 20,
        question: 'キャラクターって何？',
        answer:
          '登場人物……は正確じゃないですね．猫でもロボットでも物語上で何か行動を起こし作用するならば，それはキャラクターです．'
      },
      {
        id: 21,
        question: '役割って何？',
        answer:
          '役割は7種類あって，それぞれが特定の機能（Action）を果たします．物語の時間軸の中で，1つの役割にはたった1人のキャラクターしか適用できません．ただし途中まで敵対者だった人が助手になることがあるように，あるキャラクターの役割が物語の中で変化することもあります．別の見方をすれば，敵対者の役割が別のキャラクターに移ったとも捉えることができます．'
      },
      {
        id: 22,
        question: '外見が想像できない',
        answer:
          '詳細ではなくてもシルエットで構いません．●なら優しそうですし，▲は横柄で▼は強そうです．そのキャラにあったシルエットを用意してください．主人公にはそれとわかりやすい特徴を付けておくのが王道ですが，あえて没個性にしている作品も少なくありません．ただし没個性なだけでは本当に埋もれてしまうので，読み手の自己投影の邪魔にならない（日常で評価の対象とならない）部分で色を付けておきましょう．'
      },
      {
        id: 23,
        question: 'シーンって何？',
        answer:
          'キャラクターが機能を果たす舞台です．かみ砕いて言えば場所や時間帯のことです．'
      },
      {
        id: 24,
        question: 'どんなシーンを作ればいい？',
        answer:
          '作っても使わないことが多いので，深く考えずに量産すれば未来の自分が良いシーンを選び取ってくれます．量産が難しければ，時間帯を変えてみたり既存のシーンと光量・音量が異なるシーンを足していけばいいでしょう．'
      },
      {
        id: 25,
        question: 'プロットの終わらせ方は？',
        answer:
          '「19. 不幸・欠如の解消」「30. 敵対者の処遇決定」のいずれかを「31. エンディング」の直前におくと作りやすいです．'
      }
    ],
...
export default new Vuex.Store({
  ...
  actions: {
    ...
    [types.ADD_ACTION](
      { commit, state },
      { function31_id, character_id, world_id, abstract, note }
    ) {
      let newAction = {
    ...
    [types.ADD_WORLD]({ commit, state }, { name, light, sound, note }) {
      let newWorld = {
    ...
    [types.DELETE_CHARACTER]({ commit }, index) {
      commit(types.DELETE_CHARACTER, {
        index: index
      });
    },
    [types.DELETE_WORLD]({ commit }, index) {
